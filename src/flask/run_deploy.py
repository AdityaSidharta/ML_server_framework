...
import pandas as pd
from src.utils.envs import data_path, titanic_schema_filename, titanic_encoder_filename, titanic_model_filename
from flask_restful import reqparse, Resource
from src.components.api import Api
from src.utils.envs import minio_client
...
class Prediction(Resource):
    ...
    def get(self):
        ...
        input_class, input_sex, input_age, input_embarked = args['class'],\
                                                            args['sex'],\
                                                            args['age'],\
                                                            args['embarked']
...
def run_deploy():
    model = Api(titanic_schema_filename, titanic_encoder_filename, titanic_model_filename, minio_client)
    model.load_api()
